...
import com.github.hasys.cropper.util.CubicEasing;
import com.github.hasys.cropper.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.cropper_CropperView_cropper_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.cropper_CropperView_cropper_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
    ...
    private void setupCropBounds() {
        ...
        if (height > mThisHeight) {
            ...
            mCropRect.set(0, halfDiff + mTopPadding , mThisWidth, height + halfDiff + mTopPadding);
        }
