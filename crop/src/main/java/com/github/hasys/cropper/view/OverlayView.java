...
public class OverlayView extends View {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mOvalDimmedLayer = a.getBoolean(R.styleable.cropper_CropperView_cropper_oval_dimmed_layer, DEFAULT_OVAL_DIMMED_LAYER);
        mDimmedColor = a.getColor(R.styleable.cropper_CropperView_cropper_dimmed_color,
                getResources().getColor(R.color.cropper_color_default_dimmed));
        ...
        mShowCropFrame = a.getBoolean(R.styleable.cropper_CropperView_cropper_show_frame, DEFAULT_SHOW_CROP_FRAME);

        initCropGridStyle(a);
        mShowCropGrid = a.getBoolean(R.styleable.cropper_CropperView_cropper_show_grid, DEFAULT_SHOW_CROP_GRID);
    }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(R.styleable.cropper_CropperView_cropper_frame_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.cropper_default_crop_frame_stoke_width));
        int cropFrameColor = a.getColor(R.styleable.cropper_CropperView_cropper_frame_color,
                getResources().getColor(R.color.cropper_color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(R.styleable.cropper_CropperView_cropper_grid_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.cropper_default_crop_grid_stoke_width));
        int cropGridColor = a.getColor(R.styleable.cropper_CropperView_cropper_grid_color,
                getResources().getColor(R.color.cropper_color_default_crop_grid));
        mCropGridPaint.setStrokeWidth(cropGridStrokeSize);
        mCropGridPaint.setColor(cropGridColor);

        mCropGridRowCount = a.getInt(R.styleable.cropper_CropperView_cropper_grid_row_count, DEFAULT_CROP_GRID_ROW_COUNT);
        mCropGridColumnCount = a.getInt(R.styleable.cropper_CropperView_cropper_grid_column_count, DEFAULT_CROP_GRID_COLUMN_COUNT);
    }
