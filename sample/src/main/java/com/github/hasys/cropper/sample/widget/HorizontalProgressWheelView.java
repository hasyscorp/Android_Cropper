...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(R.color.cropper_color_progress_wheel_line));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.cropper_color_progress_wheel_line);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(R.dimen.cropper_width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(R.dimen.cropper_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(R.dimen.cropper_margin_horizontal_wheel_progress_line);
